...
public class ParkingActivity extends FragmentActivity {
    ...
    public void init(){
        ...
        rank = (LinearLayout) findViewById(R.id.parking_rank);
        nearby = (LinearLayout) findViewById(R.id.parking_nearby);
        goodReputation = (LinearLayout) findViewById(R.id.parking_good_reputation);
        ...
        Fragment contentFragment = new ParkingContentFragment();
        Fragment nearbyFragment = new ParkingNearbyFragment();
        Fragment goodReputationFragment = new ParkingGoodReputationFragment();
        Fragment rankFragment = new ParkingRankFragment();
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()){
                    case R.id.parking_nearby:
                        setChecked(0);
                        break;
                    case R.id.parking_content:
                        setChecked(1);
                        break;
                    case R.id.parking_rank:
                        setChecked(2);
                        break;
                    case R.id.parking_good_reputation:
                        setChecked(3);
                        break;
                }
            }
